...
class GeneralText2SQL(Bench):
    ...
    def __init__(self, split: str = "test", db_path: str = None, **kwargs) -> None:
    ...
    def process_results(
        self, generations: str, label: dict, return_details: bool = False, **kwargs
    ):
    ...
    def get_metrics(self):
        return {"EX": self.n_correct / self.total}
...
if __name__ == "__main__":
    ...
    fewshot_prompt = GeneralText2SQL.get_fewshot_template(schema_prompt, question).format(
